...
\begin{frame}{A note on data leakage}
\phantomsection\label{a-note-on-data-leakage}
\end{frame}

\begin{frame}{Data transformation using PCA}
\phantomsection\label{data-transformation-using-pca}
\end{frame}
...
\begin{longtable}[]{@{}rrr@{}}
\toprule\noalign{}
\textbf{Layer} & \textbf{Variable} & \textbf{Relative importance} \\
\midrule\noalign{}
\endhead
1 & BIO1 & 0.637614 \\
5 & BIO5 & 0.248376 \\
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/slides_43_1.png}}~
\end{frame}

\begin{frame}{Heterogeneous ensembles}
\phantomsection\label{heterogeneous-ensembles}
\end{frame}

\begin{frame}{Setting up an heterogeneous ensemble}
\phantomsection\label{setting-up-an-heterogeneous-ensemble}
\end{frame}
