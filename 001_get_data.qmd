...
boundingbox = (left=4.0, bottom=55.0, top=72.0, right=35.0)
...
```{julia}
Hlac = taxon("Rangifer tarandus tarandus"; strict=false)
query = [
...
```{julia}
background = pseudoabsencemask(WithinRadius, presence_layer; distance = 500.0)
